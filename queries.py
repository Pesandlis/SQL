...
def f2():
    ...
    Атрибуты вывода: название группы, фамилия студента.
...
def f4():
    ...
    Атрибуты вывода: 'Кол-во мол-х людей'. Количество строк: 1.
...
def f8():
    ...
    Атрибуты вывода: 'Факультет', 'ФИО'. Атрибут ФИО  должен состоять из фамилии,
